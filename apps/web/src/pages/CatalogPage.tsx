  ...
  return (
    <main className="shop-page catalog-page">
      <section className="catalog-intro">
        ...
        <h1>Encontre sua próxima raridade.</h1>
        <p>Filtre por tipo de produto, coleção e disponibilidade.</p>
      </section>
      <section className="catalog-layout" aria-label="Catálogo de produtos">
        <aside className="filters">
          ...
          <label>
            ...
            >
              ...
              <option value="booster">Boosters avulsos</option>
              <option value="booster-box">Caixas de boosters</option>
              <option value="elite-trainer-box">
                Caixa Treinador Avançado
              </option>
              <option value="deck">Decks prontos</option>
              <option value="collection-box">Box colecionável</option>
              <option value="tin">Latas</option>
              <option value="kit">Kits</option>
              <option value="blister">Blisters</option>
              <option value="pre-release">Pacote pré-lançamento</option>
        ...
        <div className="catalog-results">
          <p className="result-count">
            {productsQuery.data?.meta.total ?? 0} itens encontrados
          </p>
